...
if __name__ == "__main__":
    # main()
    # model = load_model('/Volumes/MacOS Data/Project/Python Webserver/open_nsfw/app/api/keras_open_nsfw/open_nsfw.h5')
    model = tf.keras.models.load_model('/Volumes/MacOS Data/Project/Python Webserver/open_nsfw/app/api/keras_open_nsfw/nsfw_mobilenet2.224x224.h5')
